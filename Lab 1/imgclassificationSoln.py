...
class ImageClassifier:
    ...
    def extract_image_features(self, data):
        ...
        for im in data:
            ...
            f = feature.hog(im_gray, orientations=10, pixels_per_cell=(
                48, 48), cells_per_block=(2, 2), feature_vector=True, block_norm='L2-Hys')
            l.append(f)
    ...
    def line_fitting(self, data):
        ...
        for im in data:
            ...
            ransac = linear_model.RANSACRegressor(
                min_samples=n, residual_threshold=t)
            X = idx[:, 0]
            X = X.reshape(-1, 1)
            y = idx[:, 1]
            ransac.fit(X, y)
            ...
            s, i = self.find_line([line_X[0, 0], line_y_ransac[0]], [
                line_X[-1, 0], line_y_ransac[-1]])
